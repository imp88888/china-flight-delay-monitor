...
class CtripAdapter(BaseAdapter):
    source = "ctrip"

    def _build_url(self, flight_no, date):
        # 示例 URL，实际接口或页面路径可能不同
        return f"https://flights.ctrip.com/itinerary/oneway/{flight_no}.html?date={date}"
    ...
    def parse(self, html: str) -> dict:
        ...
        status = text_or_none(".status") or text_or_none(".flight-status")
